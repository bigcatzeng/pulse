...
public interface IHttpRequest extends IHttpMessage {
     ...
     * port of the client or last proxy that sent the message.
     * 
     ...
     * 
     * @return a String containing the query string or <code>null</code> if the URL contains no query string. 
     */
