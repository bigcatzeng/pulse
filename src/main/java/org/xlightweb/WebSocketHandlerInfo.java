...
final class WebSocketHandlerInfo {
    ...
    WebSocketHandlerInfo(Class clazz) {
        ...
        if ((clazz != null) &&  (IWebSocketHandler.class.isAssignableFrom(clazz))) {
            ...
            isOnConnectMultithreaded = HttpUtils.isMethodMultithreaded(clazz, "onConnect", isMultiThreaded, WebSocketConnection.class);
            isOnDisconnectMultithreaded = HttpUtils.isMethodMultithreaded(clazz, "onDisconnect", isMultiThreaded, WebSocketConnection.class);
            isOnMessageMultithreaded = HttpUtils.isMethodMultithreaded(clazz, "onMessage", isMultiThreaded, WebSocketConnection.class);
