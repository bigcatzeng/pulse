...
{
    protected static Logger logger = LoggerFactory.getLogger(CRCCheck.class);

    public static void main(String[] args)
    {
        byte[] btm = new byte[] { 12, 13, 1, 0, 0, 1, 0, 31, -19, 0, 8, 0, 1 };
    ...
    public static void test()
    {
        ...
        {
            byte a = (byte) (0xff & i >> 24);
            byte b = (byte) (0xff & i >> 16);
            byte c = (byte) (0xff & i >> 8);
            byte d = (byte) (0xff & i );

            byte[] bytes = new byte[] { a,b,c,d };

            uuid = UUID.nameUUIDFromBytes(bytes).toString().replace("-","").toLowerCase();
