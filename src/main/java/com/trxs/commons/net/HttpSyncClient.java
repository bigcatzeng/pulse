...
public class HttpSyncClient
{
    ...
    public DefaultHttpClient createClient(boolean proxy)
    {
        ...
        httpParams.setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, connectTimeout);// 请求超时时间
        httpParams.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, socketTimeout);// 读取数据超时时间
