...
//            初始化向量器
    ...
    {
        String encryptedStr = AESTools.encryptCbcMode("hello world!", "4Ct7TyXZa19rgQKK", null);
        System.out.println(encryptedStr);

        String originalStr = AESTools.decryptCbcMode(encryptedStr, "4Ct7TyXZa19rgQKK", null);
        System.out.println(originalStr);

        String encryptedStr2 = AESTools.encryptEcbMode("{\"username\":\"Tom\",\"password\":\"123456\",\"mobile\":\"12306\",\"email\":\"admin@zifangsky.cn\"}", "4Ct7TyXZa19rgQKK");
        String originalStr2 = AESTools.decryptEcbMode(encryptedStr2, "4Ct7TyXZa19rgQKK");
