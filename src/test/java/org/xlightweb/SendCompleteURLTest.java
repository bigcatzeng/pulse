...
*/
public final class SendCompleteURLTest  {
	...
	public void testSimple() throws Exception {
		...
		request.setRequestURI("http://www.gmx.com/index.html");
		IHttpResponse response = httpClient.call(request);
		Assert.assertEquals(200, response.getStatus());
		
		Assert.assertEquals("http://www.gmx.com/index.html", reqHdl.getRequest().getRequestURI());
