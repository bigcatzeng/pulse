...
//		// start mbeanserver with HTML Adaptor
//		HtmlAdaptorServer adapter = new HtmlAdaptorServer();
//		ObjectName adapterName = new ObjectName("SimpleAgent:name=htmladapter,port=9933");
//		adapter.setPort(9933);
...
//
//		IHttpResponse response = httpClient.call(new GetRequest("http://localhost:" + 9933 + "/"));
