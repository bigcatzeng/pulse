...
*/
public final class MultipartResponseTest  {
	...
	public void testBuffered() throws Exception {
		...
		IHttpRequestHandler reqHdl = new IHttpRequestHandler() {
			public void onRequest(IHttpExchange exchange) throws IOException, BadMessageException {
		        ...
		        partDataSink.setFlushmode(FlushMode.ASYNC);
		        
		        BodyDataSink partDataSink2 = dataSink.writePart(new HttpMessageHeader("application/octet-stream")); 
		        partDataSink2.setFlushmode(FlushMode.ASYNC);
