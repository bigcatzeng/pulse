...
*/
public final class HttpClientClientSideCacheControlTest  {
  
    
    public static void main(String[] args) throws Exception {
        for (int i = 0; i < 10000; i++) {
            new HttpClientClientSideCacheControlTest().testNoCacheStore();
        }
    }
    

	@Test
	public void testNoCacheStore() throws Exception {
	    System.out.println("testNoCacheStore");
        ...
        request = new GetRequest("http://localhost:" + server.getLocalPort() + "/test/12345");
	...
	public void testMinFresh() throws Exception {
	    System.out.println("testMinFresh");
        ...
        IHttpRequestHandler reqHdl = new IHttpRequestHandler() {
            ...
            public void onRequest(IHttpExchange exchange) throws IOException, BadMessageException {
                HttpResponse resp = new HttpResponse(200, "text/plain", "test");
                resp.setHeader("Expires", "Fri, 30 Oct 2011 14:19:41 GMT");
                resp.setHeader("Cache-Control", "public, max-age=100");
                exchange.send(resp);
            }
        };
        ...
        request.setHeader("Cache-Control", "min-fresh=10");
        resp = httpClient.call(request);
        Assert.assertEquals(200, resp.getStatus());
        Assert.assertEquals("test", resp.getBody().readString());
        ...
        request = new GetRequest("http://localhost:" + server.getLocalPort() + "/");
        request.setHeader("Cache-Control", "min-fresh=888888");
        resp = httpClient.call(request);
        Assert.assertEquals(200, resp.getStatus());
        Assert.assertEquals("test", resp.getBody().readString());
        Assert.assertNull(resp.getHeader(CacheHandler.XHEADER_NAME));
	...
	public void testMaxStale() throws Exception {
	    System.out.println("testMaxStale");
    ...
    @Test
    public void testMaxAgeZero() throws Exception {
        System.out.println("testMaxAgeZero");
    ...
    @Test
    public void testOnlyIfCached() throws Exception {
        System.out.println("testOnlyIfCached");
        ...
        IHttpResponse resp = httpClient.call(request);
        Assert.assertEquals(504, resp.getStatus());
